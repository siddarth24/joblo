...
const App: React.FC = () => {
  ...
  const startFullProcessing = useCallback(async (skipKb: boolean = false) => {
    ...
    try {
      ...
      const mockJobData = { 
        "Job Title": "Quantum Entanglement Specialist", 
        "Company": "Nexus Corp", 
        "Location": "Orbital Station Prime", 
        "Description": "Maintain and optimize quantum communication relays. Requires deep understanding of entanglement principles.", 
        "Requirements": ["PhD in Quantum Physics", "5+ years entanglement relay experience", "Q-Sharp Programming"], 
        "Preferred": ["Telepathic communication aptitude"], 
        "Clearance": "Level Gamma-7 Required" 
      };
      const mockCvText = "Dr. Aris Thorne\nQuantum Physicist\nContact: a.thorne@nexus.corp\n...\nExperience:\n- Managed entanglement stability for Project Chimera\n- Developed Q-Sharp algorithms for relay optimization...";
      setScrapedJobData(mockJobData);
      setExtractedCvText(mockCvText);
      setOutputFilename(`${mockJobData["Job Title"] || 'Job'}_${mockJobData["Company"] || 'Company'}_Resume.docx`);
