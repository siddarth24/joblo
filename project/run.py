...
from app import create_app # Assumes 'app' is a package in the same directory as run.py (i.e. inside 'project')

app = create_app()

if __name__ == '__main__':
    app.logger.info(f"Starting Joblo API server via run.py on {app.config['HOST']}:{app.config['PORT']} (Debug: {app.config['DEBUG']})")
